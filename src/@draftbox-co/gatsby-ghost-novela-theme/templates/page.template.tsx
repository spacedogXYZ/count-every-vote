...
import ArticleAside from "@components/../sections/article/Article.Aside";
import ArticleControls from "@components/../sections/article/Article.Controls";
import ArticleShare from "@components/../sections/article/Article.Share";
...
import ArticleHero from "@components/../sections/article/Article.Hero";
...
const Page: Template = ({ pageContext, location }) => {
  ...
  return (
    <Layout>
      ...
      <ArticleHero article={article} authors={[]} />
